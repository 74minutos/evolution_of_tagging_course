    ...
    function checkOrder() {
        if (currentOrder.filter(Boolean).length === items.length) {
            ...
            if (isCorrect) {
                ...
                resultDiv.innerHTML = `✅ ¡Mensaje traducido correctamente! El evento está listo para ser escuchado por GTM.`;
                resultDiv.style.display = 'block';
                
                setTimeout(() => {
                    console.log('ADDING BUTTON TO RESULT DIV');
                    const buttonHTML = `<button class="btn-continue" style="margin-top: 1.5rem; background: #4ecdc4; color: white; padding: 15px 30px; font-size: 18px; border: 3px solid black; cursor: pointer; display: block !important; visibility: visible !important; opacity: 1 !important; z-index: 9999 !important;" onclick="document.getElementById('bloque2-game-1').style.display='none'; document.getElementById('bloque2-theory-2').style.display='block'; window.scrollTo({top:0,behavior:'smooth'});">Continuar →</button>`;
                    resultDiv.innerHTML += buttonHTML;
                    console.log('BUTTON ADDED, resultDiv innerHTML:', resultDiv.innerHTML);
                }, 1500);
            } else {
    ...
    document.querySelectorAll('#condition-options .quiz-option').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            if (isCorrect) {
                ...
                setTimeout(() => {
                    resultDiv.innerHTML += `<button class="btn-continue" style="margin-top: 1.5rem;" onclick="showScene('bloque2', 'bloque2-theory-3')">Continuar →</button>`;
                }, 1500);
            } else {
                this.classList.add('incorrect');
                resultDiv.className = 'minigame-result error';
    ...
    document.querySelectorAll(`#${containerId} .quiz-option`).forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            if (isCorrect) {
                ...
                setTimeout(() => {
                    resultDiv.innerHTML += `<button class="btn-continue" style="margin-top: 1.5rem;" onclick="showScene('bloque2', 'bloque2-theory-expandible-2')">Continuar →</button>`;
                }, 1500);
            } else {
                this.classList.add('incorrect');
                resultDiv.className = 'minigame-result error';
    ...
    document.querySelectorAll(`#${containerId} .quiz-option`).forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            if (isCorrect) {
                ...
                setTimeout(() => {
                    resultDiv.innerHTML += `<button class="btn-continue" style="margin-top: 1.5rem;" onclick="showScene('bloque2', 'bloque2-theory-expandible-3')">Continuar →</button>`;
                }, 1500);
            } else {
                this.classList.add('incorrect');
                resultDiv.className = 'minigame-result error';
    ...
    document.querySelectorAll(`#${containerId} .quiz-option`).forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            if (isCorrect) {
                ...
                setTimeout(() => {
                    resultDiv.innerHTML += `<button class="btn-continue" style="margin-top: 1.5rem;" onclick="showScene('bloque2', 'bloque2-theory-6')">Continuar →</button>`;
                }, 1500);
            } else {
                this.classList.add('incorrect');
                resultDiv.className = 'minigame-result error';
